...
class Footer {
    ...
    #copyright() { return small('©', time({datetime:this._created}, '20251231144919'), this.#author()) }
    ...
    #project() { return a(this.#externalLinkAttr(({href:`https://github.com/${this._author}/Ja16.CharSet/`})), img({class:'icon', src:`${this._prePath}asset/image/logo/github/black.svg`})) }
